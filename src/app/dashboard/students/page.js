                        ...
                        <tbody className="divide-y">
                            {students.map((student) => (
                                <tr key={student.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4"><div className="flex items-center gap-2"><Link href={`/dashboard/students/${student.id}`} className="p-2 rounded-md bg-blue-100 hover:bg-blue-200"><Eye size={16} className="text-blue-600" /></Link><button onClick={() => handleDeleteStudent(student.id)} className="p-2 rounded-md bg-red-100 hover:bg-red-200"><Trash2 size={16} className="text-red-600" /></button></div></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
